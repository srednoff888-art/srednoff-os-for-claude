...
текстовый каталог (грепай, читай, применяй вручную). Отдельная кураторская подгруппа (309 записей:
303 адаптированы из `SREDNOFF` плюс 6 более поздних импортов, см. `INSTALL-SOURCES.md`) имеет реальный `SKILL.md`-контент в
