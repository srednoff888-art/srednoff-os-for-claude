---
name: 3d-asset-pipeline-agent
description: Agent profile for glTF/GLB/model asset pipeline review in 3D web, ecommerce, AR, and configurator projects.
---

# 3D Asset Pipeline Agent

Use this agent for 3D Web work focused on review 3D asset source, license, optimization, compression, naming, and delivery pipeline.
