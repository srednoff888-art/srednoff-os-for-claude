...
description: "Agent profile for define events, funnels, attribution caveats, dashboards, data quality checks, and analytics instrumentation. Use when Claude Code needs a specialist agent perspective for planning, implementation, review, debugging, validation, or handoff in this domain."
---
