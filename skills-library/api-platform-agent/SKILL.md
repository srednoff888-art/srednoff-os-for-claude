...
description: "Agent profile for review API platform contracts, versioning, auth, rate limits, SDK clients, and developer experience. Use when Claude Code needs a specialist agent perspective for planning, implementation, review, debugging, validation, or handoff in this domain."
---
