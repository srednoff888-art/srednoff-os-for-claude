...
description: "Agent profile for prepare app store releases, metadata, screenshots, build numbers, review notes, TestFlight/Play testing, and rollout. Use when Claude Code needs a specialist agent perspective for planning, implementation, review, debugging, validation, or handoff in this domain."
---
