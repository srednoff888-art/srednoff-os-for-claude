...
description: "Agent profile for design and implement backend services, API logic, data access, jobs, auth boundaries, and error handling. Use when Claude Code needs a specialist agent perspective for planning, implementation, review, debugging, validation, or handoff in this domain."
---
