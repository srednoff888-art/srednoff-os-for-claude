...
description: "Agent profile for analyze conversion funnels, landing pages, CTAs, friction, proof, experiments, and measurement plans. Use when Claude Code needs a specialist agent perspective for planning, implementation, review, debugging, validation, or handoff in this domain."
---
