...
description: Use when Claude Code may copy or import UI code from registries, GitHub, 21st.dev, shadcn, Magic UI, Aceternity, Origin UI, React Bits, or similar sources, then adapt it to project conventions.
---
