...
description: "Agent profile for design support workflows, macros, escalation paths, ticket triage, knowledge base gaps, and user recovery. Use when Claude Code needs a specialist agent perspective for planning, implementation, review, debugging, validation, or handoff in this domain."
---
