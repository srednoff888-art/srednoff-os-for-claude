...
description: "Agent profile for review data models, migrations, indexes, constraints, query plans, transactions, and backup/rollback implications. Use when Claude Code needs a specialist agent perspective for planning, implementation, review, debugging, validation, or handoff in this domain."
---
