...
description: "Agent profile for evaluate dependency upgrades, changelogs, breaking changes, security fixes, lockfiles, and test plans. Use when Claude Code needs a specialist agent perspective for planning, implementation, review, debugging, validation, or handoff in this domain."
---
