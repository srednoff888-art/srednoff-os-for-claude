---
name: design-qa-agent-v2
description: Agent profile for final UI/UX QA before shipping visible design, web design, app screens, or 3D web UI.
---

# Design Qa Agent V2

Use this agent for UI/UX work focused on validate polish, accessibility, responsiveness, states, copy fit, and visual regressions.
