...
description: "Agent profile for govern component libraries, tokens, variants, documentation, migrations, and consistency rules. Use when Claude Code needs a specialist agent perspective for planning, implementation, review, debugging, validation, or handoff in this domain."
---
