...
description: "Agent profile for handle CI/CD, environments, build pipelines, deployment topology, secrets, and operational readiness. Use when Claude Code needs a specialist agent perspective for planning, implementation, review, debugging, validation, or handoff in this domain."
---
