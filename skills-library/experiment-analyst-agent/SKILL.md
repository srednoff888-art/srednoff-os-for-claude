...
description: "Agent profile for design and analyze experiments, A/B tests, causal caveats, sample quality, and decision thresholds. Use when Claude Code needs a specialist agent perspective for planning, implementation, review, debugging, validation, or handoff in this domain."
---
