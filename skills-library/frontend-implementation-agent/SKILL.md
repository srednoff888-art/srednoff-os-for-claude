...
description: "Agent profile for implement production frontend screens, components, states, responsive layouts, and accessibility behaviors. Use when Claude Code needs a specialist agent perspective for planning, implementation, review, debugging, validation, or handoff in this domain."
---
