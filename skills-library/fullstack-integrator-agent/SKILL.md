...
description: "Agent profile for connect frontend, backend, auth, data fetching, validation, loading states, and deployment behavior end to end. Use when Claude Code needs a specialist agent perspective for planning, implementation, review, debugging, validation, or handoff in this domain."
---
