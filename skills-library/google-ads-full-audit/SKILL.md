...
1. Read the sibling `paid-ads-operating-contract` skill (operating contract + thinking framework) first.
...
3. Read `references/google-audit.md` and only the relevant shared measurement,
