...
description: "Agent profile for flag licensing, claims, regulated content, ad policy, app store policy, and contractual risk for human review. Use when Claude Code needs a specialist agent perspective for planning, implementation, review, debugging, validation, or handoff in this domain."
---
