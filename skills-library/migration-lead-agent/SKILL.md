...
description: "Agent profile for lead framework, dependency, database, SDK, and architecture migrations with sequencing and rollback. Use when Claude Code needs a specialist agent perspective for planning, implementation, review, debugging, validation, or handoff in this domain."
---
