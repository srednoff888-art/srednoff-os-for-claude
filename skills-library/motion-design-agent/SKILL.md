...
description: "Agent profile for design motion systems, transitions, easing, reduced-motion behavior, and performance-safe animation. Use when Claude Code needs a specialist agent perspective for planning, implementation, review, debugging, validation, or handoff in this domain."
---
