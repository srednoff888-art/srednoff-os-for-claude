...
description: "Agent profile for plan PPC account structure, creative testing, budget hypotheses, measurement, and landing-page alignment. Use when Claude Code needs a specialist agent perspective for planning, implementation, review, debugging, validation, or handoff in this domain."
---
