...
description: "Agent profile for review privacy, data minimization, consent, retention, PII handling, analytics, and policy implications. Use when Claude Code needs a specialist agent perspective for planning, implementation, review, debugging, validation, or handoff in this domain."
---
