...
description: "Agent profile for prioritize product scope, user outcomes, MVP slices, roadmap tradeoffs, and launch criteria. Use when Claude Code needs a specialist agent perspective for planning, implementation, review, debugging, validation, or handoff in this domain."
---
