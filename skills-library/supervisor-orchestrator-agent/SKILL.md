...
description: "Agent profile for coordinate multi-agent work, decompose tasks, assign specialist passes, merge findings, and prevent duplicated effort. Use when Claude Code needs a specialist agent perspective for planning, implementation, review, debugging, validation, or handoff in this domain."
---
