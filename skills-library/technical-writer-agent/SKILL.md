...
description: "Agent profile for write developer docs, user docs, API docs, tutorials, changelogs, and concise implementation notes. Use when Claude Code needs a specialist agent perspective for planning, implementation, review, debugging, validation, or handoff in this domain."
---
