...
description: Use when the user explicitly enters TURBO, mode TURBO, enable TURBO, or TURBO for this task, and Claude Code should optimize for maximum quality without normal token-cost restraint.
---
