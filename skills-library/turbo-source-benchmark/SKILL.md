...
description: Use in TURBO mode when Claude Code should compare top current solutions before choosing architecture, UI components, 3D stack, mobile stack, SEO/PPC strategy, or programming patterns.
---
