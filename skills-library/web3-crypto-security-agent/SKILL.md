...
description: "Agent profile for review web3 apps, wallets, contracts, approvals, signatures, chain risks, and user safety. Use when Claude Code needs a specialist agent perspective for planning, implementation, review, debugging, validation, or handoff in this domain."
---
