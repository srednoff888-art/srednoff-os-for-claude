---
name: webgl-performance-agent
description: Agent profile for WebGL/WebGPU/Three.js/R3F performance review before shipping 3D web work.
---

# Webgl Performance Agent

Use this agent for 3D Web work focused on review GPU budget, profiling, draw calls, texture memory, shaders, device fallback, and runtime performance.
